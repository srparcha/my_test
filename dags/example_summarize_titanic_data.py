...
default_args={
    "owner": "arathi@jupitercloud.io,Open in Cloud IDE",
}

@dag(
    default_args=default_args,
    schedule=None,
    start_date=pendulum.from_format("2025-01-10", "YYYY-MM-DD"),
    catchup=False,
    owner_links={
        "arathi@jupitercloud.io": "mailto:arathi@jupitercloud.io",
        "Open in Cloud IDE": "https://cloud.astronomer.io/cm48nj8d71g7h01nlnqq6jwmj/cloud-ide/cm5r7l6iq0c2o01lmtlz3ks8e/cm5r7l6oy0c8c01nfyscjy082",
    },
)
